# daily_revenue_gross_gold

This folder defines all source code for the 'daily_revenue_gross_gold' pipeline:
...
* Take a look at the sample under "sample_users_daily_revenue_gross_gold.py" to get familiar with the syntax.
