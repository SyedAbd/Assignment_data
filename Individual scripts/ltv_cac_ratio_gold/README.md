...
This folder defines all source code for the 'ltv_cac_ratio_gold' pipeline:
...
* Take a look at the sample under "sample_users_ltv_cac_ratio_gold.py" to get familiar with the syntax.
