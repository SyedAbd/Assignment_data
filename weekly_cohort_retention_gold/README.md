# weekly_cohort_retention_gold

This folder defines all source code for the 'weekly_cohort_retention_gold' pipeline:
...
* Take a look at the sample under "sample_users_weekly_cohort_retention_gold.py" to get familiar with the syntax.
