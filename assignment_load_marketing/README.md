# assignment_load_marketing

This folder defines all source code for the 'assignment_load_marketing' pipeline:
...
* Take a look at the sample under "sample_users_assignment_load_marketing.py" to get familiar with the syntax.
