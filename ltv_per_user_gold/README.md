...
This folder defines all source code for the 'ltv_per_user_gold' pipeline:
...
* Take a look at the sample under "sample_users_ltv_per_user_gold.py" to get familiar with the syntax.
